...
static void mdio_write(u8_t addr, u8_t reg, u16_t val)
{
    ...
    *((volatile unsigned int *)((0xB0002000+0x094))) = val;
    *((volatile unsigned int *)((0xB0002000+0x098))) = (addr << 8) | reg | 0xB0000;

    while ((*((volatile unsigned int *)((0xB0002000+0x098)))) & 0x20000);    
...
{
    *((volatile unsigned int *)((0xB0002000+0x098))) = (addr << 8) | reg | 0xA0000;
    while ((*((volatile unsigned int *)((0xB0002000+0x098)))) & 0x20000);    

    return (*((volatile unsigned int *)((0xB0002000+0x094))));
}
...
static int reset_phy(void)
{
    ...
    if(delay == 0) {
        ...
        *((volatile unsigned int *)((0xB0002000+0x090))) = (*((volatile unsigned int *)((0xB0002000+0x090)))) | 0x140000;
        plugged = 0;
        return(-1);
    } else {
        ...
        if(reg & 0x0100) {
            ...
            *((volatile unsigned int *)((0xB0002000+0x090))) = (*((volatile unsigned int *)((0xB0002000+0x090)))) | 0x140000;
            ...
            sysprintf("100 half\n");
            *((volatile unsigned int *)((0xB0002000+0x090))) = ((*((volatile unsigned int *)((0xB0002000+0x090)))) & ~0x40000) | 0x100000;
        } else if(reg & 0x0040) {
            sysprintf("10 full\n");
            *((volatile unsigned int *)((0xB0002000+0x090))) = ((*((volatile unsigned int *)((0xB0002000+0x090)))) & ~0x100000) | 0x40000;
        } else {
            sysprintf("10 half\n");
            *((volatile unsigned int *)((0xB0002000+0x090))) = (*((volatile unsigned int *)((0xB0002000+0x090)))) & ~0x140000;
        }
...
static void init_tx_desc(void)
{
    ...
    *((volatile unsigned int *)((0xB0002000+0x088))) = (unsigned int)&tx_desc[0] | 0x80000000;
    return;
}
...
static void init_rx_desc(void)
{
    ...
    *((volatile unsigned int *)((0xB0002000+0x08C))) = (unsigned int)&rx_desc[0] | 0x80000000;
    return;
}
...
static void set_mac_addr(u8_t *addr)
{
    ...
    *((volatile unsigned int *)(((0xB0002000+0x008)+(0)*0x8))) = (addr[0] << 24) | (addr[1] << 16) | (addr[2] << 8) | addr[3];



    *((volatile unsigned int *)(((0xB0002000+0x00c)+(0)*0x8))) = (addr[4] << 24) | (addr[5] << 16);

    *((volatile unsigned int *)((0xB0002000+0x000))) = 0x16;
    *((volatile unsigned int *)((0xB0002000+0x004))) = 1;    
...
void ETH0_RX_IRQHandler(void)
{
    ...
    status = (*((volatile unsigned int *)((0xB0002000+0x0b0)))) & 0xFFFF;
    *((volatile unsigned int *)((0xB0002000+0x0b0))) = status;
    ...
    *((volatile unsigned int *)((0xB0002000+0x0a4))) = 0;
...
void ETH0_TX_IRQHandler(void)
{
    ...
    status = (*((volatile unsigned int *)((0xB0002000+0x0b0)))) & 0xFFFF0000;
    *((volatile unsigned int *)((0xB0002000+0x0b0))) = status;
    ...
    cur_entry = (*((volatile unsigned int *)((0xB0002000+0x0cc))));
...
void ETH0_init(u8_t *mac_addr)
{
    ...
    *((volatile unsigned int *)((0xB0000200+0x10))) = (*((volatile unsigned int *)((0xB0000200+0x10)))) | (1 << 16);            
    *((volatile unsigned int *)((0xB0000200+0x40))) = ((*((volatile unsigned int *)((0xB0000200+0x40)))) & ~0xFF) | 0xA0;     
    
    
    *((volatile unsigned int *)((0xB0000000+0x098))) = 0x11111111;
    *((volatile unsigned int *)((0xB0000000+0x09C))) = ((*((volatile unsigned int *)((0xB0000000+0x09C)))) & ~0xFF) | 0x11;
    
    
    *((volatile unsigned int *)((0xB0002000+0x090))) = 0x1000000;
    ...
    *((volatile unsigned int *)((0xB0002000+0x090))) = (*((volatile unsigned int *)((0xB0002000+0x090)))) | 0x121; 
    *((volatile unsigned int *)((0xB0002000+0x0ac))) = (*((volatile unsigned int *)((0xB0002000+0x0ac)))) | 0x01250C11;  
    sysInstallISR(1, EMC0_TX_IRQn, (PVOID)ETH0_TX_IRQHandler);
    sysInstallISR(1, EMC0_RX_IRQn, (PVOID)ETH0_RX_IRQHandler);
...
void ETH0_trigger_tx(u16_t length, struct pbuf *p)
{
    ...
    *((volatile unsigned int *)((0xB0002000+0x0a0))) = 0;
