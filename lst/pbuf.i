#line 1 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 65 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 67 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 68 "lwip-1.4.1\\src\\core\\pbuf.c"
#line 69 "lwip-1.4.1\\src\\core\\pbuf.c"
#line 70 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 71 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 72 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 73 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 75 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 81 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 102 "lwip-1.4.1\\src\\core\\pbuf.c"
...
#line 149 "lwip-1.4.1\\src\\core\\pbuf.c"
...
pbuf_pool_is_empty(void)
{
  ...
  sys_arch_unprotect(old_level);
#line 172 "lwip-1.4.1\\src\\core\\pbuf.c"
}
...
pbuf_alloc(pbuf_layer layer, u16_t length, pbuf_type type)
{
  ...
  case PBUF_RAW:
    ...
    break;
  default:
    do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: bad pbuf layer", 232, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    return 0;
  }
  ...
  case PBUF_POOL:
    ...
    do { if(!(((mem_ptr_t)p->payload % 4) == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: pbuf p->payload properly aligned", 250, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);

     
    p->tot_len = length;
     
    p->len = (((length) < (((((((1000+40+16) + 4 - 1) & ~(4-1))) + 4 - 1) & ~(4-1)) - (((offset) + 4 - 1) & ~(4-1)))) ? (length) : (((((((1000+40+16) + 4 - 1) & ~(4-1))) + 4 - 1) & ~(4-1)) - (((offset) + 4 - 1) & ~(4-1))));
    do { if(!(((u8_t*)p->payload + p->len <= (u8_t*)p + (((sizeof(struct pbuf)) + 4 - 1) & ~(4-1)) + ((((((1000+40+16) + 4 - 1) & ~(4-1))) + 4 - 1) & ~(4-1))))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "check p->payload + p->len does not overflow pbuf", 256, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);


    do { if(!((((((((1000+40+16) + 4 - 1) & ~(4-1))) + 4 - 1) & ~(4-1)) - (((offset) + 4 - 1) & ~(4-1))) > 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "PBUF_POOL_BUFSIZE must be bigger than MEM_ALIGNMENT", 259, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    ...
    while (rem_len > 0) {
      ...
      do { if(!(rem_len < 0xffff)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "rem_len < max_u16_t", 286, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
      q->tot_len = (u16_t)rem_len;
       
      q->len = ((((u16_t)rem_len) < (((((((1000+40+16) + 4 - 1) & ~(4-1))) + 4 - 1) & ~(4-1)))) ? ((u16_t)rem_len) : (((((((1000+40+16) + 4 - 1) & ~(4-1))) + 4 - 1) & ~(4-1))));
      q->payload = (void *)((u8_t *)q + (((sizeof(struct pbuf)) + 4 - 1) & ~(4-1)));
      do { if(!(((mem_ptr_t)q->payload % 4) == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: pbuf q->payload properly aligned", 291, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);

      do { if(!(((u8_t*)p->payload + p->len <= (u8_t*)p + (((sizeof(struct pbuf)) + 4 - 1) & ~(4-1)) + ((((((1000+40+16) + 4 - 1) & ~(4-1))) + 4 - 1) & ~(4-1))))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "check p->payload + p->len does not overflow pbuf", 293, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  case PBUF_RAM:
    ...
    do { if(!(((mem_ptr_t)p->payload % 4) == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: pbuf->payload properly aligned", 318, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  case PBUF_REF:
    ...
    break;
  default:
    do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: erroneous type", 340, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    return 0;
  }
...
#line 413 "lwip-1.4.1\\src\\core\\pbuf.c"
...
pbuf_realloc(struct pbuf *p, u16_t new_len)
{
  ...
  do { if(!(p != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_realloc: p != NULL", 436, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  do { if(!(p->type == PBUF_POOL || p->type == PBUF_ROM || p->type == PBUF_RAM || p->type == PBUF_REF)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_realloc: sane p->type", 437, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  while (rem_len > q->len) {
    ...
    do { if(!(grow < 0xffff)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "grow < max_u16_t", 460, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    q->tot_len += (u16_t)grow;
     
    q = q->next;
    do { if(!(q != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_realloc: q != NULL", 464, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  }
  ...
  if ((q->type == PBUF_RAM) && (rem_len != q->len)) {
    ...
    do { if(!(q != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_trim returned q == NULL", 474, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  }
...
pbuf_header(struct pbuf *p, s16_t header_size_increment)
{
  ...
  do { if(!(p != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p != NULL", 517, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  if (header_size_increment < 0){
    ...
    do { if (!((increment_magnitude <= p->len))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "increment_magnitude <= p->len", 525, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return 1;;}} while(0);
  } else {
    increment_magnitude = header_size_increment;
#line 538 "lwip-1.4.1\\src\\core\\pbuf.c"
  }
  ...
  if (type == PBUF_RAM || type == PBUF_POOL) {
    ...
    do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "bad pbuf type", 571, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    return 1;
  }
...
pbuf_free(struct pbuf *p)
{
  ...
  if (p == 0) {
    do { if(!(p != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p != NULL", 625, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  do { if(!(p->type == PBUF_RAM || p->type == PBUF_ROM || p->type == PBUF_REF || p->type == PBUF_POOL)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_free: sane type", 635, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  while (p != 0) {
    ...
    do { if(!(p->ref > 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_free: p->ref > 0", 650, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    ...
    if (ref == 0) {
      ...
      ;
      type = p->type;
#line 668 "lwip-1.4.1\\src\\core\\pbuf.c"
      {
...
pbuf_cat(struct pbuf *h, struct pbuf *t)
{
  ...
  do { if (!(((h != 0) && (t != 0)))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "(h != NULL) && (t != NULL) (programmer violates API)", 749, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return;;}} while(0);
  ...
  do { if(!(p->tot_len == p->len)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p->tot_len == p->len (of last pbuf in chain)", 758, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  do { if(!(p->next == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p->next == NULL", 759, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
...
pbuf_dechain(struct pbuf *p)
{
  ...
  if (q != 0) {
    ...
    do { if(!(q->tot_len == p->tot_len - p->len)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p->tot_len == p->len + q->tot_len", 812, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  do { if(!(p->tot_len == p->len)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p->tot_len == p->len", 829, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
...
pbuf_copy(struct pbuf *p_to, struct pbuf *p_from)
{
  ...
  do { if (!(((p_to != 0) && (p_from != 0) && (p_to->tot_len >= p_from->tot_len)))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy: target not big enough to hold source", 860, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return -14;;}} while(0);
  ...
  do
  {
    ...
    offset_to += len;
    offset_from += len;
    do { if(!(offset_to <= p_to->len)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "offset_to <= p_to->len", 877, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    do { if(!(offset_from <= p_from->len)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "offset_from <= p_from->len", 878, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
    ...
    if (offset_to == p_to->len) {
      ...
      offset_to = 0;
      p_to = p_to->next;
      do { if (!((p_to != 0) || (p_from == 0))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p_to != NULL", 888, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return -14;;}} while(0);
    }

    if((p_from != 0) && (p_from->len == p_from->tot_len)) {
       
      do { if (!((p_from->next == 0))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy() does not allow packet queues!\n", 893, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return -6;;}} while(0);

    }
    if((p_to != 0) && (p_to->len == p_to->tot_len)) {
       
      do { if (!((p_to->next == 0))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy() does not allow packet queues!\n", 898, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return -6;;}} while(0);
...
pbuf_copy_partial(struct pbuf *buf, void *dataptr, u16_t len, u16_t offset)
{
  ...
  do { if (!((buf != 0))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy_partial: invalid buf", 925, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return 0;;}} while(0);
  do { if (!((dataptr != 0))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy_partial: invalid dataptr", 926, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return 0;;}} while(0);
...
pbuf_take(struct pbuf *buf, const void *dataptr, u16_t len)
{
  ...
  do { if (!((buf != 0))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_take: invalid buf", 973, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return 0;;}} while(0);
  do { if (!((dataptr != 0))) { do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_take: invalid dataptr", 974, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); return 0;;}} while(0);
  ...
  for(p = buf; total_copy_len != 0; p = p->next) {
    do { if(!(p != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_take: invalid pbuf", 982, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  ...
  do { if(!(total_copy_len == 0 && copied_total == len)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "did not copy all data", 993, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  return 0;
}
...
pbuf_coalesce(struct pbuf *p, pbuf_layer layer)
{
  ...
  err = pbuf_copy(q, p);
  do { if(!(err == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy failed", 1023, "lwip-1.4.1\\src\\core\\pbuf.c"); } while(0); } while(0);
  pbuf_free(p);
  return q;
}

#line 1068 "lwip-1.4.1\\src\\core\\pbuf.c"
