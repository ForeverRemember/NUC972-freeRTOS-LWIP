#line 1 "lwip-1.4.1\\src\\core\\ipv4\\ip_addr.c"
...
#line 40 "lwip-1.4.1\\src\\core\\ipv4\\ip_addr.c"
...
#line 41 "lwip-1.4.1\\src\\core\\ipv4\\ip_addr.c"
...
#line 42 "lwip-1.4.1\\src\\core\\ipv4\\ip_addr.c"
...
#line 121 "lwip-1.4.1\\src\\core\\ipv4\\ip_addr.c"
...
ipaddr_aton(const char *cp, ip_addr_t *addr)
{
  ...
  case 4:              
    ...
    break;
  default:
    do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "unhandled", 243, "lwip-1.4.1\\src\\core\\ipv4\\ip_addr.c"); } while(0); } while(0);
    break;
  }
  if (addr) {
