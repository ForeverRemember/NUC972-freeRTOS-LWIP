#line 1 "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"
...
#line 79 "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"
...
#line 86 "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"
...
#line 87 "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"
	...
	static uint8_t ucHeap[ ( ( size_t ) 40 * 1024 ) ];
		...
		if( ( xWantedSize & xBlockAllocatedBit ) == 0 )
		{
			...
			if( xWantedSize > 0 )
			{
				...
				if( ( xWantedSize & ( 0x0007 ) ) != 0x00 )
				{
					...
					if((( xWantedSize & ( 0x0007 ) ) == 0)==0) do { sysprintf("Assertion \" ??? \" failed at line %d in %s\n", 191, "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"); } while(0);
				}
				else
				{
					;
			...
			if( ( xWantedSize > 0 ) && ( xWantedSize <= xFreeBytesRemaining ) )
			{
				...
				if( pxBlock != pxEnd )
				{
					...
					if( ( pxBlock->xBlockSize - xWantedSize ) > ( ( size_t ) ( xHeapStructSize << 1 ) ) )
					{
						...
						if((( ( ( size_t ) pxNewBlockLink ) & ( 0x0007 ) ) == 0)==0) do { sysprintf("Assertion \" ??? \" failed at line %d in %s\n", 236, "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"); } while(0);
...
#line 299 "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"

	if((( ( ( size_t ) pvReturn ) & ( size_t ) ( 0x0007 ) ) == 0)==0) do { sysprintf("Assertion \" ??? \" failed at line %d in %s\n", 300, "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"); } while(0);
	return pvReturn;
}
...
BlockLink_t *pxLink;
	...
	if( pv != 0 )
	{
		...
		if((( pxLink->xBlockSize & xBlockAllocatedBit ) != 0)==0) do { sysprintf("Assertion \" ??? \" failed at line %d in %s\n", 320, "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"); } while(0);
		if((pxLink->pxNextFreeBlock == 0)==0) do { sysprintf("Assertion \" ??? \" failed at line %d in %s\n", 321, "FreeRTOS\\Source\\portable\\MemMang\\heap_4.c"); } while(0);
...
size_t uxAddress;
size_t xTotalHeapSize = ( ( size_t ) 40 * 1024 );
