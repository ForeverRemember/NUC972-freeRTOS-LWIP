#line 1 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 42 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 43 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
#line 44 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 45 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 46 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 47 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
#line 48 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 49 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 50 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 51 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 52 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 53 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 54 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 55 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 56 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 57 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 58 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 60 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"


 
#line 71 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 88 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 134 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 289 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 336 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...
#line 397 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
  {
...
#line 432 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
      }
      if (first) {
        first = 0;
        netif = netif_list;
  ...
  if (netif == 0) {
    ...
    ;
#line 499 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
    {
      ;
      ;
    }
  ...
  if ((((iphdr)->_offset) & ((((0x1fffU | 0x2000U) & 0xff) << 8) | (((0x1fffU | 0x2000U) & 0xff00) >> 8))) != 0) {
    ...
    iphdr = (struct ip_hdr *)p->payload;
#line 528 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
  }

#line 547 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
...

  {
    ...
    case 1:
      ...
      icmp_input(p, inp);
      break;
#line 588 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
    default:
...
{
#line 660 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
  struct ip_hdr *iphdr;
  ip_addr_t dest_addr;
  ...
  do { if(!(p->ref == 1)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p->ref == 1", 668, "lwip-1.4.1\\src\\core\\ipv4\\ip.c"); } while(0); } while(0);
  ...
  if (dest != 0) {
    u16_t ip_hlen = 20;
#line 703 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
    ...
    iphdr = (struct ip_hdr *)p->payload;
    do { if(!((p->len >= sizeof(struct ip_hdr)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct ip_hdr", 713, "lwip-1.4.1\\src\\core\\ipv4\\ip.c"); } while(0); } while(0);
...
#line 765 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
  } else {
...
#line 795 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
          ...
          u8_t ttl, u8_t tos, u8_t proto)
{
  ...
  do { if(!(p->ref == 1)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p->ref == 1", 825, "lwip-1.4.1\\src\\core\\ipv4\\ip.c"); } while(0); } while(0);
...
#line 881 "lwip-1.4.1\\src\\core\\ipv4\\ip.c"
