#line 1 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 43 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 47 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 48 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 49 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
#line 50 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 51 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 52 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
#line 54 "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"
...
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  case 8:
    ...
    if (pbuf_header(p, (20 + 16))) {
      ...
      do { if(!((r->len >= hlen + sizeof(struct icmp_echo_hdr)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct the ICMP header", 161, "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"); } while(0); } while(0);

       
      if (pbuf_copy(r, p) != 0) {
        do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: copying to new pbuf failed\n", 165, "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"); } while(0); } while(0);
        goto memerr;
      }
      iphdr = (struct ip_hdr *)r->payload;
       
      if (pbuf_header(r, -hlen)) {
        do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: restoring original p->payload failed\n", 171, "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"); } while(0); } while(0);
        goto memerr;
      }
      ...
      if (pbuf_header(p, -(s16_t)(20 + 16))) {
        do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: restoring original p->payload failed\n", 181, "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"); } while(0); } while(0);
        goto memerr;
      }
    }
    ...
    if(pbuf_header(p, hlen)) {
      do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "Can't move over header in packet", 218, "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"); } while(0); } while(0);
    } else {
      err_t ret;
...
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  do { if(!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold icmp message", 306, "lwip-1.4.1\\src\\core\\ipv4\\icmp.c"); } while(0); } while(0);
