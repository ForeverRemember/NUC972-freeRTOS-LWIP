#line 1 "lwip-1.4.1\\src\\core\\mem.c"
...
#line 57 "lwip-1.4.1\\src\\core\\mem.c"
...
#line 61 "lwip-1.4.1\\src\\core\\mem.c"
...
#line 62 "lwip-1.4.1\\src\\core\\mem.c"
...
#line 63 "lwip-1.4.1\\src\\core\\mem.c"
...
#line 64 "lwip-1.4.1\\src\\core\\mem.c"
#line 65 "lwip-1.4.1\\src\\core\\mem.c"
...
#line 67 "lwip-1.4.1\\src\\core\\mem.c"

#line 149 "lwip-1.4.1\\src\\core\\mem.c"
...
u8_t ram_heap[((((16 * 1024)) + 4 - 1) & ~(4-1)) + (2*(((sizeof(struct mem)) + 4 - 1) & ~(4-1))) + 4];
...
#line 211 "lwip-1.4.1\\src\\core\\mem.c"
...
plug_holes(struct mem *mem)
{
  ...
  do { if(!((u8_t *)mem >= ram)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "plug_holes: mem >= ram", 241, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
  do { if(!((u8_t *)mem < (u8_t *)ram_end)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "plug_holes: mem < ram_end", 242, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
  do { if(!(mem->used == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "plug_holes: mem->used == 0", 243, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);

   
  do { if(!(mem->next <= ((((16 * 1024)) + 4 - 1) & ~(4-1)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "plug_holes: mem->next <= MEM_SIZE_ALIGNED", 246, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
...
mem_init(void)
{
  ...
  do { if(!(((((sizeof(struct mem)) + 4 - 1) & ~(4-1)) & (4-1)) == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "Sanity check alignment", 278, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
  ...
  mem->next = ((((16 * 1024)) + 4 - 1) & ~(4-1));
  mem->prev = 0;
  mem->used = 0;
   
  ram_end = (struct mem *)(void *)&ram[((((16 * 1024)) + 4 - 1) & ~(4-1))];
  ram_end->used = 1;
  ram_end->next = ((((16 * 1024)) + 4 - 1) & ~(4-1));
  ram_end->prev = ((((16 * 1024)) + 4 - 1) & ~(4-1));
  ...
  if(sys_sem_new(&mem_mutex, 1) != 0) {
    do { if(!(0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "failed to create mem_mutex", 300, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
  }
}
...
mem_free(void *rmem)
{
  ...
  do { if(!((((mem_ptr_t)rmem) & (4-1)) == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_free: sanity check alignment", 320, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);

  do { if(!((u8_t *)rmem >= (u8_t *)ram && (u8_t *)rmem < (u8_t *)ram_end)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_free: legal memory", 322, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
  ...
  do { if(!(mem->used)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_free: mem->used", 339, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
...
mem_trim(void *rmem, mem_size_t newsize)
{
  ...
  if (newsize > ((((16 * 1024)) + 4 - 1) & ~(4-1))) {
    return 0;
  }

  do { if(!((u8_t *)rmem >= (u8_t *)ram && (u8_t *)rmem < (u8_t *)ram_end)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_trim: legal memory", 390, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
  ...
  do { if(!(newsize <= size)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_trim can only shrink memory", 408, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
  if (newsize > size) {
...
mem_malloc(mem_size_t size)
{
  ...
  ;
    ...
    for (ptr = (mem_size_t)((u8_t *)lfree - ram); ptr < ((((16 * 1024)) + 4 - 1) & ~(4-1)) - size;
         ptr = ((struct mem *)(void *)&ram[ptr])->next) {
      mem = (struct mem *)(void *)&ram[ptr];
#line 547 "lwip-1.4.1\\src\\core\\mem.c"
...
#line 607 "lwip-1.4.1\\src\\core\\mem.c"
            cur = (struct mem *)(void *)&ram[cur->next];
          }
          lfree = cur;
          do { if(!(((lfree == ram_end) || (!lfree ->used)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_malloc: !lfree->used", 610, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
        }
        ;
        sys_sem_signal(&mem_mutex);
        do { if(!((mem_ptr_t)mem + (((sizeof(struct mem)) + 4 - 1) & ~(4-1)) + size <= (mem_ptr_t)ram_end)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_malloc: allocated memory not above ram_end.", 614, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);

        do { if(!(((mem_ptr_t)mem + (((sizeof(struct mem)) + 4 - 1) & ~(4-1))) % 4 == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_malloc: allocated memory properly aligned.", 616, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);

        do { if(!((((mem_ptr_t)mem) & (4-1)) == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "mem_malloc: sanity check alignment", 618, "lwip-1.4.1\\src\\core\\mem.c"); } while(0); } while(0);
