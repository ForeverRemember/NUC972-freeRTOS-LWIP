...
#line 51 "lwip-1.4.1\\src\\netif\\etharp.c"
#line 52 "lwip-1.4.1\\src\\netif\\etharp.c"
...
etharp_find_entry(ip_addr_t *ipaddr, u8_t flags)
{
  ...
  for (i = 0; i < 10; ++i) {
    ...
    if ((empty == 10) && (state == ETHARP_STATE_EMPTY)) {
      ...
      do { if(!(state == ETHARP_STATE_PENDING || state >= ETHARP_STATE_STABLE)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "state == ETHARP_STATE_PENDING || state >= ETHARP_STATE_STABLE", 299, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  ...
  if (empty < 10) {
    ...
    if (old_stable < 10) {
      ...
      do { if(!(arp_table[i]. q == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[i].q == NULL", 369, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
    ...
    do { if(!(i < 10)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "i < ARP_TABLE_SIZE", 387, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
    etharp_free_entry(i);
  }

  do { if(!(i < 10)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "i < ARP_TABLE_SIZE", 391, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  do { if(!(arp_table[i]. state == ETHARP_STATE_EMPTY)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[i].state == ETHARP_STATE_EMPTY", 392, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
...
etharp_send_ip(struct netif *netif, struct pbuf *p, struct eth_addr *src, struct eth_addr *dst)
{
  ...
  do { if(!((netif->hwaddr_len == 6))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len must be the same as ETHARP_HWADDR_LEN for etharp!", 419, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
...
{
  s8_t i;
  do { if(!(netif->hwaddr_len == 6)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len == ETHARP_HWADDR_LEN", 451, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  ;
         ...
         struct eth_addr **eth_ret, ip_addr_t **ip_ret)
{
  ...
  do { if(!(eth_ret != 0 && ip_ret != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "eth_ret != NULL && ip_ret != NULL", 608, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
...
#line 742 "lwip-1.4.1\\src\\netif\\etharp.c"
  ...
  case ((((1) & 0xff) << 8) | (((1) & 0xff00) >> 8)):
    ...
    if (for_us) {
      ...
      do { if(!((netif->hwaddr_len == 6))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len must be the same as ETHARP_HWADDR_LEN for etharp!", 785, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
#line 793 "lwip-1.4.1\\src\\netif\\etharp.c"
...
{
  do { if(!(arp_table[arp_idx]. state >= ETHARP_STATE_STABLE)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[arp_idx].state >= ETHARP_STATE_STABLE", 844, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
...
etharp_output(struct netif *netif, struct pbuf *q, ip_addr_t *ipaddr)
{
  ...
  do { if(!(netif != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "netif != NULL", 885, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  do { if(!(q != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "q != NULL", 886, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  do { if(!(ipaddr != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "ipaddr != NULL", 887, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
...
etharp_query(struct netif *netif, ip_addr_t *ipaddr, struct pbuf *q)
{
  ...
  do { if(!(((arp_table[i]. state == ETHARP_STATE_PENDING) || (arp_table[i]. state >= ETHARP_STATE_STABLE)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[i].state == PENDING or STABLE", 1049, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  ...
  if (arp_table[i].state >= ETHARP_STATE_STABLE) {
    ...
    p = q;
    while (p) {
      do { if(!((p->len != p->tot_len) || (p->next == 0))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "no packet queues allowed!", 1086, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
      if(p->type != PBUF_ROM) {
        copy_needed = 1;
        break;
      }
           ...
           const u16_t opcode)
{
  ...
  do { if(!(netif != 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "netif != NULL", 1189, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  ...
  do { if(!((p->len >= ((14 + 0) + 28)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct etharp_hdr", 1200, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
  ...
  do { if(!((netif->hwaddr_len == 6))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len must be the same as ETHARP_HWADDR_LEN for etharp!", 1208, "lwip-1.4.1\\src\\netif\\etharp.c"); } while(0); } while(0);
#line 1216 "lwip-1.4.1\\src\\netif\\etharp.c"
...
ethernet_input(struct pbuf *p, struct netif *netif)
{
  ...
  ethhdr = (struct eth_hdr *)p->payload;
  ;
#line 1301 "lwip-1.4.1\\src\\netif\\etharp.c"

  type = ethhdr->type;
#line 1327 "lwip-1.4.1\\src\\netif\\etharp.c"
