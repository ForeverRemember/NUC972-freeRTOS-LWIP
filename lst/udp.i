#line 1 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 50 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 54 "lwip-1.4.1\\src\\core\\udp.c"
#line 55 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 56 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 57 "lwip-1.4.1\\src\\core\\udp.c"
#line 58 "lwip-1.4.1\\src\\core\\udp.c"
#line 59 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 60 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 61 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 62 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 63 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 64 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 66 "lwip-1.4.1\\src\\core\\udp.c"
...
again:
  ...
  return udp_port;
#line 136 "lwip-1.4.1\\src\\core\\udp.c"
}
...
udp_input(struct pbuf *p, struct netif *inp)
{
  ...
  ;
#line 201 "lwip-1.4.1\\src\\core\\udp.c"
...

  {
    ...
    for (pcb = udp_pcbs; pcb != 0; pcb = pcb->next) {
      ...
      ;
#line 239 "lwip-1.4.1\\src\\core\\udp.c"
...
#line 253 "lwip-1.4.1\\src\\core\\udp.c"
            (broadcast &&
  ...
  if (pcb != 0 || ((&inp->ip_addr)->addr == (&current_iphdr_dest)->addr)) {
    ;
#line 326 "lwip-1.4.1\\src\\core\\udp.c"
    {
    ...
    if (pcb != 0) {
      ;
#line 400 "lwip-1.4.1\\src\\core\\udp.c"
      ...
      if (!broadcast &&
        ...
        do { if(!((p->payload == iphdr))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "p->payload == iphdr", 419, "lwip-1.4.1\\src\\core\\udp.c"); } while(0); } while(0);
...
#line 472 "lwip-1.4.1\\src\\core\\udp.c"
...
udp_sendto(struct udp_pcb *pcb, struct pbuf *p,
  ip_addr_t *dst_ip, u16_t dst_port)
{
#line 504 "lwip-1.4.1\\src\\core\\udp.c"
  struct netif *netif;
...
{
#line 563 "lwip-1.4.1\\src\\core\\udp.c"
  struct udp_hdr *udphdr;
  ip_addr_t *src_ip;
  err_t err;
  struct pbuf *q;  

#line 576 "lwip-1.4.1\\src\\core\\udp.c"
  ...
  do { if(!((q->len >= sizeof(struct udp_hdr)))) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct udp_hdr", 609, "lwip-1.4.1\\src\\core\\udp.c"); } while(0); } while(0);
...
#line 697 "lwip-1.4.1\\src\\core\\udp.c"
  {       
    ;
    ...
    if ((pcb->flags & 0x01U) == 0) {
      u16_t udpchksum;
#line 713 "lwip-1.4.1\\src\\core\\udp.c"
      {
...
udp_bind(struct udp_pcb *pcb, ip_addr_t *ipaddr, u16_t port)
{
  ...
  for (ipcb = udp_pcbs; ipcb != 0; ipcb = ipcb->next) {
    ...
    if (pcb == ipcb) {
      ...
      do { if(!(rebind == 0)) do { sysprintf("Assertion \"%s\" failed at line %d in %s\n", "rebind == 0", 781, "lwip-1.4.1\\src\\core\\udp.c"); } while(0); } while(0);
...
#line 886 "lwip-1.4.1\\src\\core\\udp.c"
  ;
...
#line 1012 "lwip-1.4.1\\src\\core\\udp.c"
